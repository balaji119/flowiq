                ...
                <tr key={file.key} className="border-t border-slate-700/70 bg-slate-800/70">
                  ...
                  <td className="border border-slate-700 px-4 py-3">
                    ...
                    <div className="flex items-center justify-center gap-2 whitespace-nowrap">
                      ...
                      >
                        {openBusy ? <LoaderCircle className="h-4 w-4 animate-spin text-violet-300" /> : <ExternalLink className="h-4 w-4" />}
                      ...
                      <Button
                        ...
                        className="h-9 w-9 px-0 2xl:h-9 2xl:w-auto 2xl:px-3"
                      >
                        {downloadBusy ? <LoaderCircle className="h-4 w-4 animate-spin text-violet-300" /> : <Download className="h-4 w-4" />}
