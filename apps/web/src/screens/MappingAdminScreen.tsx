...
export function MappingAdminScreen({ onBack, onOpenMaterialMapping, onOpenMaterials, onOpenPrintingCosts, onOpenSettings, onOpenSheetSizeSettings, onOpenShippingCosts, onOpenShippingSettings, onOpenTenants, onOpenUsers, tenantId }: MappingAdminScreenProps) {
